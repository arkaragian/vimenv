...
vim.keymap.set('n' , '<leader>ws'  , solution.WriteSolution , {desc="Write Solution to disk"  , buffer=0 } )
...
function SetupSolutionNvimKeyBindings()
    ...
    vim.keymap.set('n'   , '<leader>ft'        , solution.PickTests                , {desc="Select Test"                 , buffer=0 } )
    vim.keymap.set('n'   , '<leader>et'        , solution.PickTests                , {desc="Execute Test"                , buffer=0 } )
